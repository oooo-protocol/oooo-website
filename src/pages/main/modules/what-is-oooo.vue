...
const list = [
  {
    ...
    title: 'ENHANCING LIQUIDITY WITH SEAMLESS ASEET ABSTRACTION ACROSS ALL NETWORKS.',
    ...
    title: 'INTEGRATING LIQUIDITY AND USERS ACROSS BLOCKCHAINS AND CENTRALIZED FINACE',
